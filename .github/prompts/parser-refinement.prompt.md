...
2. **Item Mods**: In Path of Exile, equipment items can have up to 6 explicit modifiers, as well as up to 3 implicit modifiers. For explicit modifiers we know prefix and suffix modifiers. The parser should be able to identify and extract these item modifiers from the pob. The frontend should be updated to display the modifiers for alongside each equipment item.
